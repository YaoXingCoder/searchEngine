...
cleanTest:
	-rm -rf $(SPLITTOOL) $(CONFIGURATION) $(DICTPRODUCER) $(DIRSCANNER) $(RSSREADER) $(PAGELIB)
clean :
	rm -rf bin/SplitTool.o bin/Configuration.o bin/DictProducer.o bin/DirScanner.o bin/RssReader.o bin/PageLib.o
